 ...
 */
function fetchDirect(url, { method, headers, body, localAddress }) {
  return new Promise((resolve, reject) => {
    try {
      ...
      const options = {
        ...
        method,
        headers,
        family: 4, // Force IPv4 to avoid common VPN tunnel issues
        timeout: 60000,
...
async function callQwenAPI(apiKey, messages, config, taskType = "grammar", responseFormat = null) {
  ...
  const localAddress = config.QwenLocalAddress || process.env.IGT_QWEN_LOCAL_ADDRESS;

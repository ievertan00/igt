...
export function applyTheme(themeName) {
  ...
  if (themes[name]) {
    ...
    // OSC 11: set terminal window background color
...
// Restore the terminal's default background when the process exits
if (process.stdout.isTTY) {
  process.on("exit", () => { process.stdout.write("\x1b]111\x07"); });
}

...
export const api = {
  ...
  gradeCard: (cardId, correct) =>
    request("POST", "/review/grade", { card_id: cardId, correct }),
  deleteCard: (cardId) =>
    request("POST", "/review/delete", { card_id: cardId }),
  ...
  switchModel: (provider, model) =>
    request("POST", "/switch-model", { provider, model }),
